...
```
TO HANDLE NULL USE SUBQUERY SO IF THE SUBQUERRY RETURNS NOTHING THE OUTER QUERY WILL RETURN NULL
...
WE CANNOT USE AGGREGATE FUNCTIONS IN WHERE SO USE HAVING
